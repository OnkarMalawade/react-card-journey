...
const allCourses = [
    ...
    },
    {
        ...
        instructor: "MKCL Trainers",
        description:
            "Learn to create intuitive and beautiful user interfaces that drive engagement and conversions.",
    ...
    },
    {
        ...
        instructor: "MKCL Trainers",
        description:
            "Dive deep into advanced JavaScript concepts, design patterns, and modern ES6+ features.",
    ...
    },
    {
        ...
        instructor: "MKCL Trainers",
        description:
            "Get hands-on experience with Amazon Web Services and learn to deploy scalable applications.",
